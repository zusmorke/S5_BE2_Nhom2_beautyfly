                            ...
                            <div class="col l-5 m-12 s-12">
                                <div class="owl-carousel owl-theme" id="sync1">
                                    <div class="product__avt">
                                        <img src="{{ asset('img/product/' . $sanpham->hinh) }}" alt=""
                                        ...
                                        <div class="productDes__ratting-wrap">
                                            <form action="{{ route('binhluan.store') }}" method="POST">
                                                ...
                                                <input type="hidden" name="sanpham_id"
                                                    value="{{ $sanpham->sanpham_id }}">
                                                <input type="hidden" name="user_id"
                                                    value="{{ auth()->user()->user_id }}">
                                                <div id="rating">
                                                    <!-- Các input radio giữ nguyên -->
                                                    <input type="radio" id="star5" name="sao"
                                                        value="5" />
                                                    <label class="full" for="star5"
                                                        title="Awesome - 5 stars"></label>
                                                    <input type="radio" id="star4" name="sao"
                                                        value="4" />
                                                    <label class="full" for="star4"
                                                        title="Awesome - 4 stars"></label>
                                                    <input type="radio" id="star3" name="sao"
                                                        value="3" />
                                                    <label class="full" for="star3"
                                                        title="Awesome - 3 stars"></label>
                                                    <input type="radio" id="star2" name="sao"
                                                        value="2" />
                                                    <label class="full" for="star2"
                                                        title="Awesome - 2 stars"></label>
                                                    <input type="radio" id="star1" name="sao"
                                                        value="1" />
                                                    <label class="full" for="star1"
                                                        title="Awesome - 1 stars"></label>
                                                </div>
                                                ...
                                                <div class="binhluan-item">
                                                    <div class="binhluan-header">
                                                        <div class="user-info">
                                                            <i class="icon-user"></i>
                                                            <div class="user-name"
                                                                style="padding-left: 10px;font-size: 2rem;">
                                                        ...
                                                        <p class="created-at" style="padding-left: 70px;">
                                                            {{ $binhluan->created_at }}</p>
                                                    </div>
                                                    <p class="binhluan-content"
                                                        style="padding-left: 70px;font-size: 1.8rem;">
                                                        {{ $binhluan->binhluan }}</p>
                                                </div>
                                            @endforeach
                                        </div>
